...
@section('content')
    <div class="main-content-inner">
        <form action="{{ url('data-nc/tlnc/input/' . $nc->id_nc . (!empty($ref_page) ? '/' . $ref_page : '')) }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="opsi_temuan" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} id="opsi_temuan" class="form-control">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="no_nc" class="form-control" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} id="no_nc"
                                        value="{{ $nc->no_nc }}">
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_terbitnc" class="form-control" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} id="tgl_terbitnc"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} name="uraian_nc" id="uraian_nc" rows="5">{{ $nc->uraian_nc }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_deadline" class="form-control" id="tgl_deadline"
                                        value="{{ $nc->tgl_deadline }}" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }}>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="colFormLabel" class="col-sm-4 col-form-label">Rencana Tanggal
                                    Penyelesaian</label>
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_planaction" class="form-control" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditor' ? '' : 'disabled') }} id="tgl_planaction"
                                        value="{{ $nc->tgl_planaction }}">
                                </div>
                            </div>
                            <br>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="akar_masalah" value="{{ isset($tlnc->akar_masalah) ? $tlnc->akar_masalah : '' }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="uraian_perbaikan" class="form-control" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled') }} id="uraian_perbaikan" rows="5"
                                        placeholder="Masukkan uraian perbaikan" style="font-style:italic">{{ isset($tlnc->uraian_perbaikan) ? $tlnc->uraian_perbaikan : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled') }} name="uraian_pencegahan" id="uraian_pencegahan" rows="5"
                                        placeholder="Masukkan uraian pencegahan" style="font-style:italic">{{ isset($tlnc->uraian_pencegahan) ? $tlnc->uraian_pencegahan : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_action" value="{{ isset($tlnc->tgl_action) ? $tlnc->tgl_action : '' }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="name" name="disetujui_oleh" class="form-control" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled') }} id="disetujui_oleh"
                                        value="{{ isset($tlnc->disetujui_oleh) ? $tlnc->disetujui_oleh : '' }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="colFormLabel" class="col-sm-2 col-form-label">Tanggal Disetujui GM</label>
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_accgm" value="{{ isset($tlnc->tgl_accgm) ? $tlnc->tgl_accgm : '' }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditor' ? '' : 'disabled') }} name="uraian_verifikasi" id="uraian_verifikasi" rows="5"
                                        placeholder="Masukkan uraian verifikasi" style="font-style:italic">{{ isset($tlnc->uraian_verifikasi) ? $tlnc->uraian_verifikasi : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row-mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="hasil_verif"
                                        {{ isset($tlnc->hasil_verif) && $tlnc->hasil_verif == 'efektif' ? 'checked' : '' }} id="inlineRadio1"
                                        value="efektif" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditor' ? '' : 'disabled') }}>
                                    <label class="form-check-label" for="inlineRadio1">Efektif</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="hasil_verif"
                                        {{ isset($tlnc->hasil_verif) && $tlnc->hasil_verif == 'tdk_efektif' ? 'checked' : '' }} id="inlineRadio2"
                                        value="tdk_efektif" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditor' ? '' : 'disabled') }}>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="name" name="verifikator" value="{{ isset($tlnc->verifikator) ? $tlnc->verifikator : '' }}"
                                        class="form-control" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditor' ? '' : 'disabled') }} id="verifikator" placeholder="Masukkan nama verifikator"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_verif" value="{{ isset($tlnc->tgl_verif) ? $tlnc->tgl_verif : '' }}"
                                        class="form-control" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditor' ? '' : 'disabled') }} id="tgl_verif">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="colFormLabel" class="col-sm-6 col-form-label">Rekomendasi tinjauan
                                    manajemen</label>
                                <div class="col-sm-6">
                                    <textarea type="name" name="rekomendasi" class="form-control" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditor' ? '' : 'disabled') }} id="rekomendasi" rows="5"
                                        placeholder="Masukkan rekomendasi tinjauan" style="font-style:italic">{{ isset($tlnc->rekomendasi) ? $tlnc->rekomendasi : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="name" name="namasm_verif" value="{{ isset($tlnc->namasm_verif) ? $tlnc->namasm_verif : '' }}"
                                        class="form-control" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditor' ? '' : 'disabled') }} id="namasm_verif" placeholder="Masukkan nama SM Dept. TKP"
                                        style="font-style:italic">
                                </div>
                            </div>
