                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="opsi_temuan" {{ empty($tlnc) ? '' : 'disabled' }} id="opsi_temuan" class="form-control">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="no_nc" {{ empty($tlnc) ? '' : 'disabled' }} class="form-control" id="no_nc"
                                        value="{{ $nc->no_nc }}">
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="proses_audit" {{ empty($tlnc) ? '' : 'disabled' }} id="proses_audit" class="form-control">
                                        <option value="Internal" {{ $nc->proses_audit == 'Internal' ? 'selected' : '' }}>Internal</option>
                                        <option value="Eksternal" {{ $nc->proses_audit == 'Eksternal' ? 'selected' : '' }}>Eksternal</option>
                                    </select>
                                </div>
                            </div>
                            {{-- <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="tema_audit" {{ empty($tlnc) ? '' : 'disabled' }} id="tema_audit" class="form-control">
                            ...
                            <div class="row-mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="objek_audit" {{ empty($tlnc) ? '' : 'disabled' }} id="objek_audit" class="form-control">
                                        <option value="">- Pilih -</option>
                            ...
                            <div class="row-mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" type="text" value="NC" id="jenis_temuan" name="jenis_temuan" {{ empty($tlnc) ? '' : 'disabled' }}
                                        readonly>
                                </div>
                            </div>
                            <br>
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_terbitnc" {{ empty($tlnc) ? '' : 'disabled' }} class="form-control" id="tgl_terbitnc"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="bab_audit" {{ empty($tlnc) ? '' : 'disabled' }} class="form-control" id="bab_audit"
                                        value="{{ $nc->bab_audit }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="dok_acuan" {{ empty($tlnc) ? '' : 'disabled' }} class="form-control" id="dok_acuan"
                                        value="{{ $nc->dok_acuan }}">
                                </div>
                            </div>
                            ...
                            <div class="row-mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="kategori" {{ empty($tlnc) ? '' : 'disabled' }} id="kategori" class="form-control">
                                        <option value="">- Pilih -</option>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="name" name="nama_auditor" {{ empty($tlnc) ? '' : 'disabled' }} class="form-control" id="nama_auditor"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_deadline" {{ empty($tlnc) ? '' : 'disabled' }} class="form-control" id="tgl_deadline"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="name" name="diakui_oleh" {{ empty($tlnc) ? ( auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled') ) : 'disabled' }} class="form-control" id="diakui_oleh"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="name" name="disetujui_oleh" {{ empty($tlnc) ? ( auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled') ) : 'disabled' }} class="form-control" id="disetujui_oleh"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_accgm" {{ empty($tlnc) ? ( auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled') ) : 'disabled' }} class="form-control" id="tgl_accgm"
                                        value="{{ $nc->tgl_accgm }}">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="colFormLabel" class="col-sm-4 col-form-label">Rencana Tanggal
                                    Penyelesaian</label>
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_planaction" {{ empty($tlnc) ? ( auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditor' ? '' : 'disabled') ) : 'disabled' }} class="form-control" id="tgl_planaction"
