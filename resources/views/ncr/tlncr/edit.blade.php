                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="disetujui_oleh2_jabatan" id="disetujui_oleh2_jabatan"
                                        ...
                                        {{ auth()->user()->role == 'Admin1' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled') }}>
                                        <option value="">- Pilih -</option>
                                        <option {{ isset($tlncr->disetujui_oleh2_jabatan) && $tlncr->disetujui_oleh2_jabatan == 'Senior Manager' ? 'selected' : '' }}>
                                            Senior Manager</option>
                                        <option {{ isset($tlncr->disetujui_oleh2_jabatan) && $tlncr->disetujui_oleh2_jabatan == 'General manager' ? 'selected' : '' }}>
                                            General Manager</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="colFormLabel" class="col-sm-6 col-form-label">Tanda tangan diverifikasi oleh
                                    SM Dept. Tata Kelola Perusahaan</label>
                                <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                <label for="colFormLabel" class="col-sm-6 col-form-label">Tanggal verifikasi SM Dept.
                                    Tata Kelola Perusahaan</label>
                                <div class="col-sm-6">
