                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_deadline" {{ empty($tlncr) ? '' : 'disabled' }}
                                        class="form-control" id="tgl_deadline" value="{{ $ncr->tgl_deadline }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="file" name="ttd_auditee"
                                        {{ empty($tlncr) ? (auth()->user()->role == 'Admin1' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled')) : 'disabled' }}
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="name" name="diakui_oleh_jabatan_nm"
                                        {{ empty($tlncr) ? (auth()->user()->role == 'Admin1' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled')) : 'disabled' }}
                                        class="form-control" id="diakui_oleh_jabatan_nm" value="{{ $ncr->diakui_oleh_jabatan_nm }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="name" name="disetujui_oleh1_jabatan_nm"
                                        {{ empty($tlncr) ? (auth()->user()->role == 'Admin1' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled')) : 'disabled' }}
                                        class="form-control" id="disetujui_oleh1_jabatan_nm" value="{{ $ncr->disetujui_oleh1_jabatan_nm }}">
                                </div>
                            </div>
