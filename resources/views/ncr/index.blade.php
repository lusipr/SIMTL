                    ...
                    <div class="card-body">
                        <div class="d-sm-flex justify-content-between align-items-center">
                            ...
                            @if (auth()->user()->role == 'Admin' || auth()->user()->role == 'Auditor')
                                <a href="{{ url('data-ncr/add') }}" style="margin-bottom:20px" class="btn btn-success">Tambah
                                    NCR</a>
                            @endif
                        </div><br>
                                ...
                                <tbody>
                                    @foreach ($ncr as $data_ncr)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $data_ncr->no_ncr }}</td>
                                            <td class="text-center">{{ $data_ncr->proses_audit }}</td>
                                            <td class="text-center">{{ $data_ncr->tema_audit }}</td>
