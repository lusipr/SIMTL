                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="hasil_verif"
                                        {{ isset($tlofi->hasil_verif) && $tlofi->hasil_verif == 'efektif' ? 'checked' : '' }} id="inlineRadio1"
                                        value="efektif" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }}>
                                    <label class="form-check-label" for="inlineRadio1">Efektif</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="hasil_verif"
                                        {{ isset($tlofi->hasil_verif) && $tlofi->hasil_verif == 'tdk_efektif' ? 'checked' : '' }} id="inlineRadio2"
