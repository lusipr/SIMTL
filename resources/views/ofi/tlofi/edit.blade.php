...
@section('content')
    <div class="main-content-inner">
        <form action="{{ url('data-ofi/tlofi/input/' . $ofi->id_ofi . (!empty($ref_page) ? '/' . $ref_page : '')) }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="no_ofi" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="proses_audit" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} id="proses_audit" class="form-control">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="tema_audit" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} id="tema_audit" class="form-control">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_terbitofi" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control"
                            ...
                            <div class="row-mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="status" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} id="status" class="form-control">
                                        <option value="">- Pilih -</option>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="proyek" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="usulan_ofi" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="uraian_permasalahan" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }}
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="usulan_peningkatan" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }}
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="dept_pengusul" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_diusulkan" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="disetujui_oleh" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_disetujui" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control"
                            ...
                            <div class="row-mb-3">
                                <label for="colFormLabel" class="col-sm-4 col-form-label">Disposisi Wakil
                                    Manajemen</label>
                                <div class="col-sm-6">
                                    <select name="disposisi" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} id="disposisi" class="form-control">
                                        <option value="">- Pilih -</option>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_deadline" class="form-control" id="tgl_deadline"
                                        value="{{ $ofi->tgl_deadline }}" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }}>
                                </div>
                            </div>
                            <br>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="colFormLabel" class="col-sm-4 col-form-label">Tindak Lanjut Usulan
                                    Peningkatan</label>
                                <div class="col-sm-6">
                                    <input type="text" name="tl_usulanofi" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled') }}
                                        value="{{ isset($tlofi->tl_usulanofi) ? $tlofi->tl_usulanofi : '' }}" class="form-control" id="tl_usulanofi"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="nama_pekerjatl" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled') }}
                                        value="{{ isset($tlofi->nama_pekerjatl) ? $tlofi->nama_pekerjatl : '' }}" class="form-control" id="nama_pekerjatl"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_tl" {{ auth()->user()->role == 'Admin' ? '' : (auth()->user()->role == 'Auditee' ? '' : 'disabled') }}
                                        value="{{ isset($tlofi->tgl_tl) ? $tlofi->tgl_tl : '' }}" class="form-control" id="tgl_tl">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <textarea type="text" name="uraian_verif" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control" id="uraian_verif"
                                        rows="5" placeholder="Masukkan uraian verifikasi" style="font-style:italic">{{ isset($tlofi->uraian_verif) ? $tlofi->uraian_verif : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <textarea type="text" name="hasil_verif" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control" id="hasil_verif"
                                        rows="5" placeholder="Masukkan hasil verifikasi" style="font-style:italic">{{ isset($tlofi->hasil_verif) ? $tlofi->hasil_verif : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="nama_verifikator" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }}
                                        value="{{ isset($tlofi->nama_verifikator) ? $tlofi->nama_verifikator : '' }}" class="form-control" id="nama_verifikator"
                                        placeholder="Masukkan disini" style="font-style:italic">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="tgl_verif" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }}
                                        value="{{ isset($tlofi->tgl_verif) ? $tlofi->tgl_verif : '' }}" class="form-control" id="tgl_verif">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <textarea type="text" name="eval_saran" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control" id="eval_saran" rows="5"
                                        placeholder="Masukkan evaluasi saran" style="font-style:italic">{{ isset($tlofi->eval_saran) ? $tlofi->eval_saran : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="nama_evaluator" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }}
                                        value="{{ isset($tlofi->nama_evaluator) ? $tlofi->nama_evaluator : '' }}" class="form-control" id="nama_evaluator"
                                        placeholder="Masukkan disini" style="font-style:italic">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="skor" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }}
                                        value="{{ isset($tlofi->skor) ? $tlofi->skor : '' }}" class="form-control" id="skor"
                            ...
                            <div class="mb-3">
                                <label for="colFormLabel" class="col-sm-6 col-form-label">Rekomendasi Tinjauan
                                    Manajemen</label>
                                <div class="col-sm-6">
                                    <textarea type="text" name="rekom_tinjauan" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }} class="form-control" id="rekom_tinjauan"
                                        rows="5" placeholder="Masukkan rekomendasi disini" style="font-style:italic">{{ isset($tlofi->rekom_tinjauan) ? $tlofi->rekom_tinjauan : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="namasm_verifikator" {{ auth()->user()->role == 'Admin' ? '' : 'disabled' }}
                                        value="{{ isset($tlofi->namasm_verifikator) ? $tlofi->namasm_verifikator : '' }}" class="form-control" id="namasm_verifikator"
                                        placeholder="Masukkan disini" style="font-style:italic">
                                </div>
                            </div>
